...
|------------|---------|-------------|
| **[Panthera-HT_Main](https://github.com/HighTorque-Robotics/Panthera-HT_Main)** | [MIT](LICENSE) | Main project repository with documentation and links |
| **[Panthera-HT_SDK](https://github.com/HighTorque-Robotics/Panthera-HT_SDK)** | [MIT](LICENSE) | C++ and Python SDK (this repository) |
| **[Panthera-HT_ROS2](https://github.com/HighTorque-Robotics/Panthera-HT-ROS2)** | [MIT](LICENSE) | ROS2 driver and simulation support |
| **[Panthera-HT_Model](https://github.com/HighTorque-Robotics/Panthera-HT_Main)** | [MIT](LICENSE) | SolidWorks CAD files and BOM |
...
| 仓库 | 许可证 | 说明 |
|------|--------|------|
| **[Panthera-HT_Main](https://github.com/HighTorque-Robotics/Panthera-HT_Main)** | [MIT](LICENSE) | 主项目仓库，包含文档和链接 |
| **[Panthera-HT_SDK](https://github.com/HighTorque-Robotics/Panthera-HT_SDK)** | [MIT](LICENSE) | C++ 和 Python SDK（本仓库） |
| **[Panthera-HT_ROS2](https://github.com/HighTorque-Robotics/Panthera-HT-ROS2)** | [MIT](LICENSE) | ROS2 驱动和仿真支持 |
| **[Panthera-HT_Model](https://github.com/HighTorque-Robotics/Panthera-HT_Main)** | [MIT](LICENSE) | SolidWorks CAD 文件和 BOM |
